    ...
    <div>
      <div class="imput-desk">
        <div class=" text-imput">
          <input placeholder="Login" class="input" type="text" name="login" id="Login"/>
        </div>
        <div class=" text-imput">
          <input placeholder="Password" class="input" type="text" id="Password"/>
        </div>
      </div>
      ...
      <div id="button-div">
        ...
        <button class="button-3" role="button">Регистрация</button>
      </div>
    </div>
  </section>
</template>
